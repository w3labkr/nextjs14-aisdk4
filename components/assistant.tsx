...
export function Assistant({ api = '/api/assistant' }: { api?: string }) {
  const { status, messages, input, submitMessage, handleInputChange } = useAssistant({ api })
  ...
  return (
    <Card className="border-none shadow-none">
      ...
      <CardFooter>
        <form onSubmit={submitMessage} className="flex w-full space-x-2">
